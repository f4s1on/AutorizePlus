...
class ConfigurationTab():
    ...
    def draw(self):
        ...
        self._extender.autoDecrypt = JCheckBox("Auto Decrypt")
        self._extender.autoDecrypt.setBounds(280, 105, 300, 30)
        self._extender.autoDecrypt.setSelected(False)
        ...
        self._extender.removeHeadersButton.setBounds(400, 135, 80, 30)
        ...
        self._extender.savedHeadersTitlesCombo.setBounds(10, 135, 300, 30)
        ...
        scrollReplaceString.setBounds(10, 170, 470, 150)

        fromLastRequestLabel = JLabel("From last request:")
        fromLastRequestLabel.setBounds(10, 325, 250, 30)
        ...
        self._extender.fetchCookiesHeaderButton.setBounds(10, 350, 220, 30)
        ...
        self._extender.fetchAuthorizationHeaderButton.setBounds(260, 350, 220, 30)
        ...
        self._extender.filtersTabs.addTab("Encrypt/Decrypt", self._extender.DEPnl)
        ...
        self._extender.filtersTabs.setBounds(0, 370, 2000, 700)
        ...
        self.config_pnl.add(self._extender.autoDecrypt)
